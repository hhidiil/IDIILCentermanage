    ...
    <div v-if="true">
      <div class="file-upload">
        <el-upload
          ...
          <el-button slot="trigger" type="primary">Excel批量导入</el-button>
          <!--<el-button slot="trigger" size="mini" type="primary">自制文本素材</el-button>-->
        </el-upload>
      </div>
      <div class="file-list">
  ...
  export default {
    ...
    data(){
      return{
        ...
        enlargeImage:'', //放大图片地址
        action: 'http://nwprodsub.idiil.com.cn:9999/api/user/uploadExcel',
        paramsData: {
            "username":'aaa',//msg.username,
            "SchoolID":'000',//"009",
            "ClassID":''
        }
      }
...
/*    computed: {
    ...
    methods:{
      ...
      * */
      submitUpload() {
        this.$refs.upload.submit(); //上传文件 "/api/user/uploadExcel"
      },
        beforeUpload(file){//文件上传之前的钩子
          this.paramsData.username=this.msg.username
          this.paramsData.SchoolID=this.msg.SchoolID
          this.paramsData.ClassID=this.msg.ClassID
      },
      //文件上传时的钩子
