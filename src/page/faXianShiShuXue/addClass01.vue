        ...
        <el-row>
          <el-col :span="24">
            <el-card class="box-card">
              <div class="rowBox cardTop" v-if="editClassFlag">
                <el-form :model="sourceLists" status-icon :rules="classRules" ref="classForm" class="demo-classForm">
                  <el-form-item label="课程名称:" prop="className">
                    <span>
                      <el-input v-model="sourceLists.classList.name" ></el-input>
                    </span>
                  </el-form-item>
                  <el-form-item label="课程目标:" prop="classTarget">
                    <span>
                  ...
                  <el-form-item label="对应版本:" prop="classVersion">
                    <span>
                  ...
                  <el-form-item>
                    ...
                    <span>
                        <el-button size="mini" @click="saveClass('classForm')">保存</el-button>
                    </span>
                    </div>
                  </el-form-item>
                </el-form>
              </div>
              <div class="rowBox cardTop" v-else>
                <el-form :model="sourceLists" status-icon :rules="classRules" ref="classForm" class="demo-classForm">
                  <el-form-item label="课程名称:">
                    <span>{{sourceLists.classList.name}}</span>
                  </el-form-item>
                  <el-form-item label="课程目标:" prop="classTarget">
                    <span>{{sourceLists.classList.target}}</span>
                  </el-form-item>
                  <el-form-item label="课程时长:" prop="classTime">
                    <span>{{sourceLists.classList.duration}}</span>
                  </el-form-item>
                  <el-form-item label="对应版本:" prop="classVersion">
                    <span>{{sourceLists.classList.version}}</span>
                  </el-form-item>
                  <el-form-item>
                    <div class="button-group">
                    <span>
